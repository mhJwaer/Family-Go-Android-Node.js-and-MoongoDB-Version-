...
import com.mh.jwaer.familygo.databinding.FragmentChangePermissionsBinding;
...
public class ChangeAdminPermissionsFragment extends Fragment implements MembersAdapter.OnItemClickListener {

    private SettingsViewModel viewModel;
    private FragmentChangePermissionsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_change_permissions, container, false);
    ...
    public void onStart() {
        ...
        viewModel.getAdminRes().observe(requireActivity(), new Observer<ResponseBody>() {
            @Override
        ...
        viewModel.getErrorResponse().observe(this, new Observer<ErrorResponse>() {
            ...
            public void onChanged(ErrorResponse errorResponse) {
                loadingDialog.dissmissDialog();
                Toast.makeText(requireContext(), errorResponse.getError().getMessage(), Toast.LENGTH_SHORT).show();
                binding.textView.setText(getString(R.string.admin_permission_desc_connectivity));
            }
        });
    }
    ...
    public void onItemClicked(final int position) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext())
                ...
                .setCancelable(false)
                .setMessage("are you sure to delete '" + adapterList.get(position).getName() + "'\nthis action cannot be undo")
                .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        viewModel.setNewAdmin(adapterList.get(position).getUid());
                        dialog.dismiss();
                        loadingDialog.startAlertDialog();
                    }
                })
